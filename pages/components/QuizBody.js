...
/*  componentDidUpdate(prevProps, nextProps){
  ...
  render() {
    console.log(cookie.load('qtonix_quiz_userdata'))
    return (
        <>
  ...
  <header>
    <nav className="navbar navbar-expand-xl navbar-light bg-transparent">
      <div className="container">
        ...
        :
        <><img src={`${cookie.load('qtonix_quiz_userdata').clogo}?tr=w-150`} alt="Logo" className="img-fluid" />
        </>
        }
      ...
      <div className="container">
        <div className="footer__bottom-content">
          <div className="footer__bottom_copyright">
            <p>© 2022 - Developed By Qtonix. All rights reserved</p>
          </div>
...
var BodyWithRouter=withRouter(QuizBody);
