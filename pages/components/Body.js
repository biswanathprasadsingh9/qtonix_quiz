            ...
            <div className="navbar-mobile__menu">
              <ul className="navbar-mobile__menu-list">
                <li className="active navbar-mobile__menu-item">
                  ...
                  <ul className="navbar-mobile__menu-dropmenu">
                    <li><a href="index.html" className="active">Homepage 01</a></li>
                    <li><a href="home-02.html">Homepage 02</a></li>
                    <li><a href="home-03.html">Homepage 03</a></li>
                  </ul>
                </li>
                <li className="navbar-mobile__menu-item">
                  <a href="#">
                    <span className="navbar-mobile__menu-link"> Courses </span>
                    <span className="navbar-mobile__menu-dropicon">
                      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-right">
                        <polyline points="9 18 15 12 9 6" />
                      </svg>
                ...
                <li className="navbar-mobile__menu-item">
                  <a href="about.html">
                    <span className="navbar-mobile__menu-link"> About </span>
                  </a>
                </li>
                <li className="navbar-mobile__menu-item">
                  <a href="#">
                    <span className="navbar-mobile__menu-link"> Events </span>
                    <span className="navbar-mobile__menu-dropicon">
                      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-right">
                        <polyline points="9 18 15 12 9 6" />
                      </svg>
                ...
                <li className="navbar-mobile__menu-item">
                  <a href="#">
                    <span className="navbar-mobile__menu-link"> Pages </span>
                    <span className="navbar-mobile__menu-dropicon">
                      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-right">
                        <polyline points="9 18 15 12 9 6" />
                      </svg>
                ...
                <li className="navbar-mobile__menu-item">
                  <a href="contact.html">
                    <span className="navbar-mobile__menu-link"> Contact </span>
                  </a>
                </li>
              </ul>
            </div>
              ...
              <li>
                <a href="#">
                  <svg width={9} height={18} viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.3575 2.98875H9.00075V0.12675C8.71725 0.08775 7.74225 0 6.60675 0C4.2375 0 2.6145 1.49025 2.6145 4.22925V6.75H0V9.9495H2.6145V18H5.82V9.95025H8.32875L8.727 6.75075H5.81925V4.5465C5.82 3.62175 6.069 2.98875 7.3575 2.98875Z" fill="currentColor" />
                  </svg>
                </a>
              </li>
            </ul>
        ...
        <div className="col-lg-6">
          <div className="footer__wrapper">
            <div className="footer__wrapper_logo">
              <img src="dist/images/logo/footerlogo.png" alt="logo" className="img-fluid" />
            </div>
            <p>
            ...
            <div className="footer__wrapper_social d-none d-lg-block">
              <ul>
                ...
                <li>
                  <a href="#">
                    <svg width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17.9955 18.0002V17.9994H18V11.3979C18 8.16841 17.3047 5.68066 13.5292 5.68066C11.7142 5.68066 10.4962 6.67666 9.99896 7.62091H9.94646V5.98216H6.3667V17.9994H10.0942V12.0489C10.0942 10.4822 10.3912 8.96716 12.3315 8.96716C14.2432 8.96716 14.2717 10.7552 14.2717 12.1494V18.0002H17.9955Z" fill="white" />
                ...
                <li>
                  <a href="#">
                    <svg width={18} height={14} viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M16.0427 0.885481C16.8137 1.09312 17.4216 1.70094 17.6291 2.47204C18.0148 3.88048 17.9999 6.81629 17.9999 6.81629C17.9999 6.81629 17.9999 9.73713 17.6293 11.1457C17.4216 11.9167 16.8138 12.5246 16.0427 12.7321C14.6341 13.1029 8.99996 13.1029 8.99996 13.1029C8.99996 13.1029 3.38048 13.1029 1.95721 12.7174C1.18611 12.5098 0.57829 11.9018 0.37065 11.1309C0 9.73713 0 6.80146 0 6.80146C0 6.80146 0 3.88048 0.37065 2.47204C0.578153 1.70108 1.20094 1.07829 1.95707 0.870787C3.36565 0.5 8.99983 0.5 8.99983 0.5C8.99983 0.5 14.6341 0.5 16.0427 0.885481ZM11.8913 6.80154L7.20605 9.50006V4.10303L11.8913 6.80154Z" fill="white" />
                    </svg>
                  </a>
                </li>
                <li>
            ...
            <a href="#">
              ...
              <div className="icon ms-2">
                <svg width={10} height={6} viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9 5L5 1L1 5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            </a>
          </div>
...
var BodyWithRouter=withRouter(Body);
